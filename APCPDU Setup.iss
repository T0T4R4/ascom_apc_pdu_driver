...
; Generated by T0T4R4 on 19/03/2019 (UTC)
;
[Setup]
AppID={{486eb8bb-05df-4ae0-a168-c48543bd076a}
AppName=ASCOM APCPDU Switch Driver
AppVerName=ASCOM APCPDU Switch Driver 1.0.0
AppVersion=1.0.0
...
OutputDir="."
OutputBaseFilename="APCPDU Setup"
Compression=lzma
...
UninstallFilesDir="{cf}\ASCOM\Uninstall\Switch\APCPDU"

[Languages]
Name: "english"; MessagesFile: "compiler:Default.isl"

[Dirs]
Name: "{cf}\ASCOM\Uninstall\Switch\APCPDU"
...
Filename: "{dotnet4032}\regasm.exe"; Parameters: "/codebase ""{app}\ASCOM.APCPDU.Switch.dll"""; Flags: runhidden 32bit
Filename: "{dotnet4064}\regasm.exe"; Parameters: "/codebase ""{app}\ASCOM.APCPDU.Switch.dll"""; Flags: runhidden 64bit; Check: IsWin64
...
[UninstallRun]
; Only for .NET assembly/in-proc drivers
Filename: "{dotnet4032}\regasm.exe"; Parameters: "-u ""{app}\ASCOM.APCPDU.Switch.dll"""; Flags: runhidden 32bit
; This helps to give a clean uninstall
Filename: "{dotnet4064}\regasm.exe"; Parameters: "/codebase ""{app}\ASCOM.APCPDU.Switch.dll"""; Flags: runhidden 64bit; Check: IsWin64
Filename: "{dotnet4064}\regasm.exe"; Parameters: "-u ""{app}\ASCOM.APCPDU.Switch.dll"""; Flags: runhidden 64bit; Check: IsWin64
